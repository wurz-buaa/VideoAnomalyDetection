...
python3 feat_optical_flow_extract.py $dataset 1

## extracting raw feature data
#resz=[240,360]
#resz=[158,238]
resz=[256,256]
python3 feat_raw_extract.py $dataset $resz 1
...
python3 extract_high_feat_from_cae_brox_batch_v5_release.py $dataset 1 $batchsize $modeldir test1 $device
python3 extract_high_feat_from_cae_brox_batch_v5_release.py $dataset 2 $batchsize $modeldir test1 $device
...
skip_frame=1
python3 train_hvad_GANv5_brox_largev2_reshape_release.py $dataset train 0 False AtoB $skip_frame $modeldir 1
python3 train_hvad_GANv5_brox_largev2_reshape_release.py $dataset train 0 False BtoA $skip_frame $modeldir 1
python3 train_hvad_GANv5_brox_largev2_reshape_release.py $dataset train 3 False AtoB $skip_frame $modeldir 1
python3 train_hvad_GANv5_brox_largev2_reshape_release.py $dataset train 3 False BtoA $skip_frame $modeldir 1
